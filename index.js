...
const total = GAMES_JSON.reduce((acc, game)=> acc + game.backers, 0 );
...
const totalMoney = GAMES_JSON.reduce((acc, game)=> acc + game.pledged, 0 );
...
function filterUnfundedOnly() {
    ...
    const filterGames = GAMES_JSON.filter((game)=> game.pledged < game.goal );
